...
#Upper Station Early Run brood table formatting

library(readxl)

b <- read_excel('data/original/westward brood tables.xlsx', sheet = 6, skip = 4, n_max = 48)
...
write.csv(b, 'data/reformatted/UpperStationEarly_sockeye.csv', row.names = F)
