#Kasilof River brood table formatting

library(readxl)

b <- read_excel('data/original/Kenai and Kasilof Sockeye Salmon Brood Tables.xlsx', sheet = 2, skip = 2, n_max = 51)
...
write.csv(b, 'data/reformatted/Kasilof_sockeye.csv', row.names = F)
