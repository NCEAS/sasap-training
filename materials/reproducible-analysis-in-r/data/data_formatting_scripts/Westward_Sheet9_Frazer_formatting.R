...
#Frazer brood table formatting

library(readxl)

b <- read_excel('data/original/westward brood tables.xlsx', sheet = 9, skip = 5, n_max = 51)
...
colnames(b) <- c("BroodYear", "TotalEscapement",'R0.2',"R1.1","R0.3","R1.2","R2.1", "R1.3","R2.2",'R3.1',
                 "R1.4","R2.3","R3.2",'R4.1',"R2.4", 'R4.2',"R3.3","Stock.ID","Species",'Stock',"Region","Sub.Region","UseFlag")
...
write.csv(b, 'data/reformatted/Frazer_sockeye.csv', row.names = F)
