...
b <- read_excel('data/original/westward brood tables.xlsx', sheet = 2, skip = 5, n_max = 37)
...
colnames(b) <- c("BroodYear", "TotalEscapement","R0.1",'R0.2',"R1.1","R0.3","R1.2","R2.1",'R0.4',"R1.3","R2.2",'R3.1',
                 "R1.4","R2.3","R3.2", 'R1.5',"R2.4","R3.3","R3.4","Stock.ID","Species",'Stock',"Region","Sub.Region","UseFlag")
...
write.csv(b, 'data/reformatted/Bear_sockeye.csv', row.names = F)
