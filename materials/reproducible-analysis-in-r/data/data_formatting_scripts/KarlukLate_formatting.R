...
#Karluk Late Run brood table formatting

library(readxl)

b <- read_excel('data/original/westward brood tables.xlsx', sheet = 7, skip = 5, n_max = 41)
...
write.csv(b, 'data/reformatted/KarlukLate_sockeye.csv', row.names = F)
