...
```{r read}
b <- read_excel('/home/sjclark/BroodTables/Original_excels/112_COGHILL_BROOD_TABLE.xls', skip = 6)
colnames(b)
```
...
```{r write file, eval = F}
write.csv(b, '/home/sjclark/BroodTables/Reformatted/Coghill_sockeye.csv', row.names = F)
```
