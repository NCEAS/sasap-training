...
including genetics [@ioannidis_repeatability_2009] and 
...
Workflows can range in detail from simple flowcharts such as \@ref(fig:worflow) 
to fully executable scripts. R scripts and python scripts are a textual forms 
of a workflow, and when researchers save specific versions of the scripts and 
...
being developed to help researchers share stock assessments consistently and completely.
