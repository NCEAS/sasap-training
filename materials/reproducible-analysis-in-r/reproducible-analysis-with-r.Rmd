...
Source information, including who initially requested the data and the year in which it was obtained, is shown in Table 2. I also think I should just include source info directly in this table instead of having two tables, but will wait on overall table feedback from Bryce
...
| Stock.ID | BroodYear | Region | Sub.Region | UseFlag | BroodYear | TotalEscapement | R0.1 | ... | R4.5 |
|-|-|-|-|-|-|-|-|-|-|
</p>
...
```{r}
knitr::read_chunk("data/data_formatting_scripts/Coghill_formatting.R")
```
...
<!--chapter:end:02-literate-analysis.Rmd-->
...
<!--chapter:end:03-setup-rstudio-git-github.Rmd-->
