...
```{r, echo=FALSE}
# The above code chunk that looks a lot like this code chunk is what the user
# sees in the rendered copy and this code chunk actually makes the map. This is
# all a workaround for leaflet's CDN having certificate issues that prevent
# Chrome (and probably other browsers) from loading the marker images
# See: https://github.com/NCEAS/sasap-training/issues/22)
leaflet(locations) %>% 
  addTiles() %>% 
